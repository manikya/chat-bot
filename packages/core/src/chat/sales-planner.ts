      ...
      messages: [
        {
          ...
          content:
            ...
            "For broad gift/use-case/occasion requests such as 'best gifts for birthdays' that do not name a concrete offering type and do not include recipient or budget, ask one sales question before search: prefer missingSlot:'recipient' when catalogHints.audiences has values, otherwise missingSlot:'budget'. " +
            ...
            "Exception: if latestMessage says 'more like', 'similar', 'like this', or asks for alternatives to a shown offering, do not treat it as close intent; set userMove:'show_more', contextPolicy:'show_more', action:'search_products', gateProductSearch:false, and search for similar offerings. " +
            "If latestMessage asks which recently shown offering is suitable/best/good for a use case or occasion, keep the existing product context and recent shown offerings; do not reset to a broad use-case search. Set contextPolicy:'continue', action:'search_products', gateProductSearch:false, searchQuery combining the existing product context with the new use case, and do not ask budget before giving relevant options. " +
