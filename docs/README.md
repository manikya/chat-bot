...
📡 **[API implementation status](implementation/06-api-implementation-status.md)** — built vs remaining + **what to build next** (last updated 2026-06-14).

🚀 **[AWS deploy guide](../infra/aws-serverless-deployment.md)** — `npm run deploy:aws:full` (IAM + ingest + crons).
