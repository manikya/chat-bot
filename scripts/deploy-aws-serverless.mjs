...
const BASE_ROUTES = [
  ...
  ["POST", "/webhooks/commerce/woocommerce", "webhook-commerce"],
  ...
  ["GET", "/api/v1/mobile-ai/snapshot", "knowledge-jobs"],
  ...
  ["POST", "/api/v1/commerce/shopify/connect-store", "commerce-shopify", "connectStoreHandler"],
  ...
  ["GET", "/api/v1/commerce/shopify/widget", "commerce-shopify", "widgetSettingsHandler"],
  ["PATCH", "/api/v1/commerce/shopify/widget", "commerce-shopify", "widgetPatchHandler"],
  ...
  ["POST", "/shopify-app/app/widget", "shopify-app"],
